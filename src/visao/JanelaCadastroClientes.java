...
public class JanelaCadastroClientes extends javax.swing.JDialog {
     ...
     */
    public JanelaCadastroClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        pai = parent;
        initComponents();
...
//            }
    ...
    public void salvar(){
        ...
        cli.setVeiculos(this.veiculos);
            ...
            JOptionPane.showMessageDialog(null, "Alguma informação inválida ou está faltando campos a serem preenchidos!");
        }
    }
