...
public class JanelaCadastroUsuario extends javax.swing.JDialog {
    ...
    public JanelaCadastroUsuario(java.awt.Frame parent, boolean modal, Usuario usuario) {
        ...
        if(usuario.getTipo().equals(Usuario.TIPO_GERENTE)){
            jvendedor.setSelected(false);
            jgerente.setSelected(true);
        }else{
            jvendedor.setSelected(true);
            jgerente.setSelected(false);
        }
    ...
    private void initComponents() {
        ...
        jvendedor = new javax.swing.JRadioButton();
        ...
        buttonGroup1.add(jgerente);
        jgerente.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jgerente.setText("Gerente");

        buttonGroup1.add(jvendedor);
        jvendedor.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    ...
    private void editar(){
        ...
        try {
            usuario.setSenha(String.valueOf(jsenha.getPassword()));
        ...
        try{
            if(senha.equals(confirma)){
                ...
                if(jgerente.isSelected()){
                    usuario.setTipo(Usuario.TIPO_GERENTE);
                }else{
                    usuario.setTipo(Usuario.TIPO_VENDEDOR);
                }
                FachadaControle.getFachadaControle().cadastrarUsuario(usuario);
...
//    }
    ...
    private javax.swing.JRadioButton jvendedor;
