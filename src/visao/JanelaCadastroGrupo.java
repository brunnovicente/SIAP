 ...
 * @author Bruno
 */
public class JanelaCadastroGrupo extends javax.swing.JDialog {
    
    private Grupo grupo;
    /**
     * Creates new form JanelaCadastroFabricante
     */
    public JanelaCadastroGrupo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.grupo = null;
    ...
    public JanelaCadastroGrupo(java.awt.Frame parent, boolean modal,Grupo grupo) {
        super(parent, modal);
        initComponents();
        this.grupo = grupo;
        this.setLocationRelativeTo(null);
        jnome.setText(grupo.getNome());
        jcodigo.setText(grupo.getCodigo()+"");
    ...
    public void cadastrar(){
        ...
        try {
            if(!jnome.getText().equals("")){
                if(this.grupo == null){
                    Grupo g = FachadaControle.getFachadaControle().salvarGrupo(jnome.getText());
                    jcodigo.setText(""+g.getCodigo());
                    jbutaoSalvar.setEnabled(false);
                    this.dispose();
                }else{
                    this.grupo.setNome(jnome.getText());
                    Grupo g = FachadaControle.getFachadaControle().editarGrupo(this.grupo);
                    this.dispose();
                }
            }else{
