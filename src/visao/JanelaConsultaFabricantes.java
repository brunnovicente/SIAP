...
import visao.processos.BuscaFabricante;
 ...
 * @author Bruno
 */
public class JanelaConsultaFabricantes extends javax.swing.JDialog {
     ...
     */
    public JanelaConsultaFabricantes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public JanelaConsultaFabricantes(java.awt.Frame parent, boolean modal, Fabricante fabricante) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.pai = (TelaPrincipal) parent;
   ...
   /**
    ...
    private void initComponents() {
        ...
        setTitle("CONSULTA DE FABRICANTES");
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Consulta de Fabricantes"));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Pesquisa de Fabricantes"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JanelaCadastroFabricante cadastro = new JanelaCadastroFabricante(this.pai, true);
    ...
    public void excluir(){
        try {
            ...
            int confirma = JOptionPane.showConfirmDialog(null, "Os produtos relacionados à esse fabricante serão afetados. Tem certeza que deseja excluir este fabricante?", "Excluir Fabricante", JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
            if(confirma == JOptionPane.YES_OPTION){
                Fabricante fabricante = FachadaControle.getFachadaControle().excluirFabricante(codigo);
                this.atualizaTabela();
                JOptionPane.showMessageDialog(null, "Fabricante '"+fabricante.getNome()+"' excluído com sucesso!", "Confirmação", JOptionPane.INFORMATION_MESSAGE);
                jpesquisa.requestFocus();
            }            
            ...
            if(ex.getMessage().equals("-1")){
                ...
                if(ex.getMessage().contains("while")){
                    JOptionPane.showMessageDialog(null, "Não pode excluir um fabricante relacionado à um produto!");
                    ex.printStackTrace();
                }else{
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(null, ex.getMessage());
    ...
    public void editar(){
        try{
            ...
            JanelaCadastroFabricante editar = new JanelaCadastroFabricante(this.pai, true,f);
    ...
    public void atualizaTabela(){
        try {
            List<Fabricante> lista = FachadaControle.getFachadaControle().consultaFabricantes(jpesquisa.getText());
            ...
            BuscaFabricante processo = new BuscaFabricante(jtabela, lista);
            processo.start();
    ...
    public void enviar(){
        try{
            //Fabricante f = new Fabricante();
            fabricante.setCodigo(Integer.parseInt((String)jtabela.getValueAt(jtabela.getSelectedRow(), 0)));
            fabricante.setNome((String)jtabela.getValueAt(jtabela.getSelectedRow(), 1));
            this.dispose();
        }catch(Exception ex){
            JOptionPane.showMessageDialog(null, "Selecione um Fabricante!");
        }
