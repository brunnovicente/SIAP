...
import visao.processos.Servidor;
...
//        }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        JanelaRedefenir janelaRedefenir = new JanelaRedefenir(this, true);
        janelaRedefenir.setVisible(true);
    }//GEN-LAST:event_jLabel5MouseClicked

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        JanelaConfiguraServidor janela = new JanelaConfiguraServidor(this, true);
    ...
    private void login(){
        ...
        try {
            Usuario usuario = FachadaControle.getFachadaControle().fazerLogin(login, senha);
