 ...
 * @author Bruno
 */
public class JanelaPainelPedidos extends javax.swing.JInternalFrame {
     ...
     */
    public JanelaPainelPedidos(List<Pedido> pedidos) {
        initComponents();
    ...
    public void atualizaTabela(){
            ...
            for(Pedido pedido : pedidos){
                ...
                linha[2] = df.format(pedido.getDataPrevista());
                modelo.addRow(linha);
            }
    }
