...
import visao.processos.BuscaFornecedor;
 ...
 * @author Bruno
 */
public class JanelaConsultaFornecedor extends javax.swing.JDialog {
     ...
     */
    public JanelaConsultaFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public JanelaConsultaFornecedor(java.awt.Frame parent, boolean modal, Fornecedor fornecedor) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.pai = (TelaPrincipal) parent;
   ...
   /**
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Consulta de Fornecedores"));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Pesquisa de Fornecedores"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jpesquisa, javax.swing.GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(jbutaoadd, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JanelaCadastroFornecedor cadastro = new JanelaCadastroFornecedor(this.pai, true);
    ...
    public void excluir(){
        try {
            ...
            int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir este forncedor?", "Excluir Fornecedor", JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
            if(confirma == JOptionPane.YES_OPTION){
                Fornecedor fornecedor = FachadaControle.getFachadaControle().excluirFornecedor(codigo);
                this.atualizaTabela();
                JOptionPane.showMessageDialog(null, "Fornecedor '"+fornecedor.getNome()+"' excluído com sucesso!", "Confirmação", JOptionPane.INFORMATION_MESSAGE);
                jpesquisa.requestFocus();
            }            
            ...
            if(ex.getMessage().equals("-1")){
                ...
                if(ex.getMessage().contains("while")){
                    JOptionPane.showMessageDialog(null, "Não pode excluir um fornecedor relacionado à um produto!");
                }else{
                    JOptionPane.showMessageDialog(null, ex.getMessage());
                }
            }
    ...
    public void editar(){
        try{
            ...
            f.setCodigo(Integer.parseInt((String)jtabela.getValueAt(jtabela.getSelectedRow(), 0)));
            f.setNome((String)jtabela.getValueAt(jtabela.getSelectedRow(), 1));
            f.setStatus("Ativo");
            JanelaCadastroFornecedor editar = new JanelaCadastroFornecedor(this.pai, true,f);
    ...
    public void atualizaTabela(){
        try {
            List<Fornecedor> lista = FachadaControle.getFachadaControle().buscaFornecedores(jpesquisa.getText());
            ...
            BuscaFornecedor processo = new BuscaFornecedor(jtabela, lista);
            processo.start();
    ...
    public void enviar(){
        try{
            ...
            fornecedor.setCodigo(Integer.parseInt((String)jtabela.getValueAt(jtabela.getSelectedRow(), 0)));
            fornecedor.setNome((String)jtabela.getValueAt(jtabela.getSelectedRow(), 1));
            this.dispose();
        }catch(Exception ex){
            JOptionPane.showMessageDialog(null, "Selecione um Fornecedor!");
        }
